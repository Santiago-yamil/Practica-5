...
public class ListaDinamica<E> implements Lista<E>, Serializable {
	
	private static final long serialVersionUID = 1L; 
	
	private NodoLista<E> p,u,s;
	private int size;
	
	public ListaDinamica() {
		this.s=this.p=this.u=null;
		this.size=0;
	}
	...
	public E obtenerItemS() {
		return  this.s.getItem();
	}

	public NodoLista<E> getS() {
		return s;
	}

	public void reiniciarS() {
		this.s = this.p;
	}
